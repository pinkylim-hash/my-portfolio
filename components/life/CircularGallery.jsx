  ...
  if (!effectiveUrl) {
    if (document.fonts && document.fonts.load) {
      try {
        ...
        // Browser fallback is acceptable if the host page already controls fonts.
      }
    }
    return font;
  }
  ...
  try {
    ...
    if (document.fonts && document.fonts.load) {
      try {
        ...
        // Render with the requested family even if readiness reporting fails.
      }
    }
...
class Media {
  ...
  update(scroll, direction) {
    ...
    if (this.bend === 0) {
      ...
      const bendAmount = Math.abs(this.bend);
      const radius = (halfViewport * halfViewport + bendAmount * bendAmount) / (2 * bendAmount);
